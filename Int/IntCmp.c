...
bool __attribute__((always_inline))  Or(    ijolInt **X, ijolInt **Y);  //^ X  == 1 || Y == 1
bool __attribute__((always_inline))  And(   ijolInt **X, ijolInt **Y);  //^ X  == 1 && Y == 1
bool __attribute__((always_inline))  Not(   ijolInt **X             );  //^ X == 1 = 0; X == 0 = 1;

bool __attribute__((always_inline))  sOr(    ijolInt **X, ijolInt **Y);  //^ X  == 1 || Y == 1      This for safe (this is precary)
bool __attribute__((always_inline))  sAnd(   ijolInt **X, ijolInt **Y);  //^ X  == 1 && Y == 1      This for safe (this is precary)
...
bool inline Or(ijolInt **X, ijolInt **Y){
...
bool inline And(ijolInt **X, ijolInt **Y){
  //^ (DataX[0] == 0 && DataY[0] == 0) = 0
...
bool __attribute__((always_inline)) Not(ijolInt **X){
  //^ (Data[0] == 0) = 1
  //^ (Data[0] == 1) = 0
  return !(*(*X)->Data);
}

bool __attribute__((always_inline)) sOr(ijolInt **X, ijolInt **Y){
  //^ (DataX[0] == 0 && DataY[0] == 0) = 0
  //^ (DataX[0] == 1 && DataY[0] == 0) = 1
  //^ (DataX[0] == 0 && DataY[0] == 1) = 1
  //^ (DataX[0] == 1 && DataY[0] == 1) = 1
...
bool __attribute__((always_inline)) sAnd(ijolInt **X, ijolInt **Y){
  //^ (DataX[0] == 0 && DataY[0] == 0) = 0
  //^ (DataX[0] == 1 && DataY[0] == 0) = 0
  //^ (DataX[0] == 0 && DataY[0] == 1) = 0
  //^ (DataX[0] == 1 && DataY[0] == 1) = 1
